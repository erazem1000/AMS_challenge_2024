...
For this project, a predefined dataset will be used, containing CT imaging modalities that simulate real-world clinical scenarios. This dataset enables an in-depth examination of multiGradICON's strengths and limitations across different types of images and anatomical regions. End goal is to sucessfully register first unimodal images of the same anatomical region after determining optimal hyperparameters and later on multimodal ones.
